...
const IoPort = require('./IoPort'),
      ReadableAggregate = require('./aggregates/ReadableAggregate'),
      WritableAggregate = require('./aggregates/WritableAggregate');
...
class TailwindApp {
  constructor ({ identityProviders = [], profiling = {}} = {}) {
    ...
    this.ReadableAggregate = ReadableAggregate;
    this.WritableAggregate = WritableAggregate;
    ...
    this.api.prepareEventForForwarding = async function () {
      throw new Error('Invalid operation.');
    };
