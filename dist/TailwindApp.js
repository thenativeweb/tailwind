...
function () {
  function TailwindApp(_ref) {
    ...
    if (identityProvider) {
      ...
      this.identityProvider.certificate = fs.readFileSync(identityProvider.certificate, {
        encoding: 'utf8'
      });
    ...
    this.Event = Event;
    this.api = new IoPort(this); // The read function takes the three parameters modelType, modelName and
    // readOptions.
